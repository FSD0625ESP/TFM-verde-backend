...
const { register, login, me, logout, googleLogin, generateForgotPasswordToken, verifyForgotPasswordToken, changePassword, contactForm } = require('../controllers/userController');
