...
const createSeeds = async () => {
    try {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            const productTypes = ['Camiseta', 'Bolso', 'Cuadro', 'Lámpara', 'Collar', 'Pulsera', 'Vestido', 'Decoración', 'Escultura', 'Anillo'];
...
mongoose
    .connect(MONGODB_URI || 'mongodb://localhost:27017/tfm-database')
    .then(() => {
